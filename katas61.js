...
import {equal, deepEqual, notEqual} from 'assert'; //we added this line to make it passed import a single member, 'deepEqual', and 'notEqual'
import {equal as myEqual} from 'assert'; //added this line to passed 'member as alias'
import {default as myAssert} from 'assert'; //added this line to use 'default as alias'
