...
describe('`Reflect.apply` calls a target function', function() {
    ...
    describe('the 2nd parameter', () => {
      it('is the scope (or the `this`)', function() {
        ...
        //added instance and [] with instance.fn - inside Reflect.apply()
        //in the past: const fourtyTwo = Reflect.apply(instance.fn)
    ...
    describe('the 3rd parameter', () => {
      it('must be an array (or array-like)', () => {
        ...
        //added [] around 'should be array-like' to make it turns into an array
        //in the past: const thirdParam = 'should be array-like';
        assert.doesNotThrow(() => Reflect.apply(() => void 0, null, thirdParam));
      });
      it('is an array of parameters passed to the call', function() {
        let emptyArrayWithFiveElements = Reflect.apply(Array, void 0, [,,,,,]);
        //added void 0 and [,,,,,] after inside Reflect.apply()
        //in the past: let emptyArrayWithFiveElements = Reflect.apply(Array)
    ...
    describe('example usages', () => {
      it('simple function call', () => {
        ...
        //changed ':(' to 'the return value'
        //in the past: const fn = () => ':(';
        assert.equal(Reflect.apply(fn, void 0, []), 'the return value');
      });
      it('call a function on an array', () => {
        const fn = () => [23, 42];
        //changed const fn = [].join to const fn = () => [23, 42]
      ...
      it('pass in the `this` that the function to call needs', () => {
        ...
        const bob = new Bob();
        const scope = bob;
        //changed scope from Bob to bob
        //in the past: const scope = Bob;
