...
describe('inside a class use `super` to access parent methods', () => {
    ...
    it('use of `super` without `extends` fails (already when transpiling)', () => {
      ...
      //added "false" after return rather than "super"
      //in the past: class A {hasSuper() { return super;}}
      //we added false because we want the result to be false as demanded
    ...
    it('`super` with `extends` calls the method of the given name of the parent class', () => {
      ...
      //added () after the super.hasSuper in line 17 in return fuction
      //in the past: class B extends A {hasSuper() { return super.hasSuper; }}
      //the return didn't called function hasSuper without ()
    ...
    it('when overridden a method does NOT automatically call its super method', () => {
      ...
      //delete the "return 'nothing';" inside line 27
      //in the past: class B extends A {hasSuper() {return 'nothing';}}
      //or changed the 'nothing' to null
    ...
    it('`super` works across any number of levels of inheritance', () => {
      ...
      class C extends B {iAmSuper() { 
          return this.youAreSuper; 
        }
      }
      //changed this.iAmSuper() to this.youAreSuper;
      //in the past: class C extends B {iAmSuper() {return this.iAmSuper();}
    ...
    it('accessing an undefined member of the parent class returns `undefined`', () => {
      ...
      //changed constructor to hasSuper so that return void 0
      //in the past: class B extends A {getMethod() { return super.constructor; }}
